...
#ifndef ISTEAMNETWORKINGSOCKETS002_H
#define ISTEAMNETWORKINGSOCKETS002_H
#ifdef _WIN32
#pragma once
#endif
...
public:
	...
	virtual bool GetHostedDedicatedServerAddress002( SteamDatagramHostedAddress *pRouting ) = 0;
...
protected:
	...
	// ~ISteamNetworkingSockets002(); // Silence some warnings
};

#define STEAMNETWORKINGSOCKETS_INTERFACE_VERSION_002 "SteamNetworkingSockets002"

#endif // ISTEAMNETWORKINGSOCKETS002_H
