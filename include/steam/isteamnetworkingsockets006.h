...
#ifndef ISTEAMNETWORKINGSOCKETS006_H
#define ISTEAMNETWORKINGSOCKETS006_H
#ifdef _WIN32
#pragma once
#endif
...
protected:
	...
	// ~ISteamNetworkingSockets006(); // Silence some warnings
};

#define STEAMNETWORKINGSOCKETS_INTERFACE_VERSION_006 "SteamNetworkingSockets006"

#endif // ISTEAMNETWORKINGSOCKETS006_H
