...
{
    VLOG_INFO(__FUNCTION__ " - hSteamPipe: %d", hSteamPipe);
}
...
{
    VLOG_INFO(__FUNCTION__ " - hSteamPipe: %d, hSteamAPICall: %llu, cubCallback: %d, iCallbackExpected: %d", hSteamPipe, hSteamAPICall, cubCallback, iCallbackExpected);
    return false;
}
