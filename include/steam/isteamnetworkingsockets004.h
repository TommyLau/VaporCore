...
#ifndef ISTEAMNETWORKINGSOCKETS004_H
#define ISTEAMNETWORKINGSOCKETS004_H
#ifdef _WIN32
#pragma once
#endif
...
protected:
	...
	// ~ISteamNetworkingSockets004(); // Silence some warnings
};

#define STEAMNETWORKINGSOCKETS_INTERFACE_VERSION_004 "SteamNetworkingSockets004"

#endif // ISTEAMNETWORKINGSOCKETS004_H
