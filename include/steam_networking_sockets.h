...
#ifndef VAPORCORE_STEAM_NETWORKING_SOCKETS_H
#define VAPORCORE_STEAM_NETWORKING_SOCKETS_H
#ifdef _WIN32
#pragma once
#endif
...
public:
	// Singleton accessor
    static CSteamNetworkingSockets& GetInstance()
    {
		static CSteamNetworkingSockets instance;
		return instance;
    }
	...
	/// ignored.
	bool CloseConnection( HSteamNetConnection hPeer, int nReason, const char *pszDebug, bool bEnableLinger ) override;
	...
	void SetConnectionName( HSteamNetConnection hPeer, const char *pszName ) override;

	/// Fetch connection name.  Returns false if handle is invalid
	bool GetConnectionName( HSteamNetConnection hPeer, char *pszName, int nMaxLen ) override;
	...
	int ReceiveMessagesOnConnection( HSteamNetConnection hConn, SteamNetworkingMessage_t **ppOutMessages, int nMaxMessages ) override; 
	...
	int ReceiveMessagesOnListenSocket( HSteamListenSocket hSocket, SteamNetworkingMessage_t **ppOutMessages, int nMaxMessages ) override; 

	/// Returns basic information about the high-level state of the connection.
	bool GetConnectionInfo( HSteamNetConnection hConn, SteamNetConnectionInfo_t *pInfo ) override;

	/// Returns a small set of information about the real-time state of the connection
	/// Returns false if the connection handle is invalid, or the connection has ended.
	bool GetQuickConnectionStatus( HSteamNetConnection hConn, SteamNetworkingQuickConnectionStatus *pStats ) override;
	...
	int GetDetailedConnectionStatus( HSteamNetConnection hConn, char *pszBuf, int cbBuf ) override;

	/// Returns local IP and port that a listen socket created using CreateListenSocketIP is bound to.
	///
	/// An IPv6 address of ::0 means "any IPv4 or IPv6"
	/// An IPv6 address of ::ffff:0000:0000 means "any IPv4"
	bool GetListenSocketAddress( HSteamListenSocket hSocket, SteamNetworkingIPAddr *address ) override;
	...
	bool CreateSocketPair( HSteamNetConnection *pOutConnection1, HSteamNetConnection *pOutConnection2, bool bUseNetworkLoopback, const SteamNetworkingIdentity *pIdentity1, const SteamNetworkingIdentity *pIdentity2 ) override;
	...
	bool SetConnectionPollGroup( HSteamNetConnection hConn, HSteamNetPollGroup hPollGroup ) override;
	...
	/// other connections.)
	int ReceiveMessagesOnPollGroup( HSteamNetPollGroup hPollGroup, SteamNetworkingMessage_t **ppOutMessages, int nMaxMessages ) override;
	...
	bool ReceivedRelayAuthTicket( const void *pvTicket, int cbTicket, SteamDatagramRelayAuthTicket *pOutParsedTicket ) override;
	...
	int FindRelayAuthTicketForServer( const SteamNetworkingIdentity &identityGameServer, int nVirtualPort, SteamDatagramRelayAuthTicket *pOutParsedTicket ) override;
	...
	EResult GetHostedDedicatedServerAddress( SteamDatagramHostedAddress *pRouting ) override;
	// Changed from Steam SDK v1.45, backward compatibility
	bool GetHostedDedicatedServerAddress002( SteamDatagramHostedAddress *pRouting ) override;
...
//
	...
	void RunCallbacks( ISteamNetworkingSocketsCallbacks *pCallbacks ) override;
#endif
...
private:
    ...
    CSteamNetworkingSockets(const CSteamNetworkingSockets&) = delete;
    CSteamNetworkingSockets& operator=(const CSteamNetworkingSockets&) = delete;
};

#endif // VAPORCORE_STEAM_NETWORKING_SOCKETS_H
